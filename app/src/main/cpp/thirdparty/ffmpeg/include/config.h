...
#define FFMPEG_CONFIGURATION "--prefix=/Users/zhaoliangtai/Downloads/build-libffmpeg/FFmpeg_android/arm --sysroot=/Users/zhaoliangtai/Downloads/android-ndk-r16b/platforms/android-19/arch-arm/ --target-os=android --arch=arm --cross-prefix=/Users/zhaoliangtai/Downloads/android-ndk-r16b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --enable-cross-compile --disable-runtime-cpudetect --cpu=cortex-a8 --disable-doc --disable-debug --enable-ffmpeg --disable-ffprobe --disable-decoders --enable-decoder=aac --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=gif --enable-decoder=mp3 --enable-decoder=h264 --enable-decoder=pcm_s16le --disable-encoders --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=mp2 --disable-muxers --enable-muxer=avi --enable-muxer=flv --enable-muxer=mp4 --enable-muxer=m4v --enable-muxer=mp3 --enable-muxer=mov --enable-muxer=h264 --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=mjpeg --enable-demuxer=m4v --enable-demuxer=gif --enable-demuxer=mov --enable-demuxer=avi --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=wav --disable-ffserver --disable-protocols --enable-protocol=rtmp --enable-protocol=file --enable-protocol=http --enable-static --disable-shared --enable-pic --enable-gpl --enable-postproc --disable-stripping --enable-small --enable-version3 --disable-asm --enable-libx264 --enable-encoder=libx264 --extra-cflags='-fpic -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300 -I/Users/zhaoliangtai/Downloads/build-libffmpeg/x264_android/arm/include -I/Users/zhaoliangtai/Downloads/android-ndk-r16b/sysroot/usr/include/arm-linux-androideabi -isysroot /Users/zhaoliangtai/Downloads/android-ndk-r16b/sysroot -D__ANDROID_API__=19 -U_FILE_OFFSET_BITS -O3 -pipe -Wall -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID' --extra-ldflags=-L/Users/zhaoliangtai/Downloads/build-libffmpeg/x264_android/arm/lib"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/zhaoliangtai/Downloads/build-libffmpeg/FFmpeg_android/arm/share/ffmpeg"
#define AVCONV_DATADIR "/Users/zhaoliangtai/Downloads/build-libffmpeg/FFmpeg_android/arm/share/ffmpeg"
